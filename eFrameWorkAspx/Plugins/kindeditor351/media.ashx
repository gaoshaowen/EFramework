...
public class Upload : IHttpHandler, IReadOnlySessionState
{
    ...
    private String fileTypes = "mp3,swf,flv,f4v,mp4,wav,wma,wmv,mid,avi,mpg,asf,rm,rmvb";//定义允许上传的文件扩展名
    private int maxSize = 1000 * 1024 * 1024;//1000000;//1000M,最大文件大小
	...
	{        
        ...
        sb.Append("</head>");
        sb.Append("<body>");
        sb.Append("<script type=\"text/javascript\">parent.KE.plugin[\"newmedia\"].insert(\"" + id + "\", \"" + url + "\",\"" + w + "\",\"" + h + "\");</script>");
        sb.Append("</body>");
        sb.Append("</html>");
