...
public class Upload : IHttpHandler, IReadOnlySessionState
{
    ...
    private String fileTypes = "doc,docx,rtf,csv,xls,xlsx,ppt,rar,zip,pdf,txt,gif,jpg,jpeg,png,bmp";//定义允许上传的文件扩展名
    private int maxSize = 100 * 1024 * 1024;//1000000;//100M,最大文件大小
