<%@ Page Title="" Language="C#" MasterPageFile="~/Examples/Main.Master" AutoEventWireup="true" CodeBehind="eFormControl.aspx.cs" Inherits="eFrameWork.Examples._eFormControl" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div class="nav">您当前位置：首页 -> eFormControl控件<a id="btn_add" style="float:right;margin-top:10px;<%=( action.Value == "" ? "" : "display:none;" )%>" class="button" href="<%=eform.getAddURL()%>"><span><i class="add">添加</i></span></a></div>
...
<tr>
<td class="title"><%=(action.Value == "add" || action.Value == "edit" ? "<ins>*</ins>" : "")%>密码：</td>
...
<tr>
<td class="title"><%=(action.Value == "add" || action.Value == "edit" ? "<ins>*</ins>" : "")%>兴趣爱好：</td>
...
<td class="title"><%=(action.Value == "add" || action.Value == "edit" ? "<ins>*</ins>" : "")%>学历：</td>
...
{
%>
<a class="button" href="javascript:;" onclick="submitform('frmaddoredit');"><span><i class="save"><%=(action.Value == "add" ? "添加" : "保存")%></i></span></a><%}%>
...
<div style="margin:8px;"><ev:ePageControl ID="ePageControl1" showPageSize="true" PageSize="10" PageNum="9" runat="server" /></div>
<%}%>
</div>
</asp:Content>
