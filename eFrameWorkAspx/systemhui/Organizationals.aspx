<%@ Page Language="C#" MasterPageFile="~/Master/huiMain.Master" AutoEventWireup="true" CodeBehind="Organizationals.aspx.cs" Inherits="eFrameWork.systemhui.Organizationals" %>
...
<a id="btn_add" class="btn btn-primary radius r" style="margin-top:4px;<%=( (Action.Value == "" || Action.Value == "view" ) && model.Power["Add"].ToString().ToLower()=="true" ? "" : "display:none;" )%>" class="button" href="javascript:;" dataid="<%=pid%>" onclick="add(this);"><i class="Hui-iconfont">&#xe600;</i> 添加</a>
<%
}
}
%>
