<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartMore.aspx.cs" Inherits="eFrameWork.systemhui.PartMore" %>
<%
if (act == "getjson")
{
...
<%}%>
<div style="margin-top:10px;color:#555;"><b>说明：</b>自定义页面 1 v n</div>