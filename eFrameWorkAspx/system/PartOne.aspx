<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartOne.aspx.cs" Inherits="eFrameWork.system.PartOne" %>
<div style="margin-bottom:10px;color:#555;"><b>说明：</b>以下内容为自定义页面 1 v 1</div>
<%
if(act=="getjson")
{
