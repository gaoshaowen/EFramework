...
namespace eFrameWork.Master
{
    ...
    public partial class systemMenu : System.Web.UI.UserControl
    {
        ...
        protected DataTable allModels
        {
            get
            {
                if (_allmodels == null)
                {
                    string sql = "SELECT ModelID,Type,ParentID,MC,Auto,AspxFile,PX,addTime FROM a_eke_sysModels where delTag=0 and subModel=0 order by px";                   
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //eBase.Writeln(ItemIDS.Count.ToString());
        ...
        private string getMenus(string ParentID)
        {
           ...
           // sb.Append(Models.Rows.Count.ToString());
            if (ParentID.Length == 0)
            {
                sb.Append("<ul class=\"emenu\">\r\n");
                sb.Append("<li" + (aspfile == "default.aspx" ? " class=\"cur\"" : "") + "><a href=\"Default.aspx\" onfocus=\"this.blur();\"" + (aspfile == "default.aspx" ? " class=\"cur\"" : "") + ">首页</a></li>\r\n");
