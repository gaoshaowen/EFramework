<%@ Page Title="" Language="C#" MasterPageFile="~/Master/manageMain.Master" AutoEventWireup="true" CodeBehind="ToKens.aspx.cs" Inherits="eFrameWork.Manage.ToKens" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div class="nav">您当前位置：<a href="Default.aspx">首页</a> -> 令牌管理</div>
<script>
...
<ev:eListControl ID="eDataTable" Class="eDataTable" CellSpacing="1" LineHeight="32" runat="server" >
    ...
    <ev:eListColumn ControlType="text" Field="UserID" FieldName="用户" BindObject="a_eke_sysUsers" BindText="XM" BindValue="UserID" runat="server" />
    <ev:eListColumn ControlType="text" Field="ExpireDate" FieldName="过期时间" FormatString="{0:yyyy-MM-dd HH:mm:ss}" runat="server" />
    ...
    <a href="{base:url}act=del&id={data:ID}" onclick="javascript:return confirm('确认要移除吗？');">移除</a>
</ev:eListColumn>
</ev:eListControl>
